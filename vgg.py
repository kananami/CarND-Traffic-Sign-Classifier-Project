...
class MyDataset(Data.Dataset):
    def __init__(self,root='./data',train='train',transform=None,target_transform=None,loader=default_loader):
        ...
        # The above method of loading images is too much memory and has to give up and use the following loading method.

        # self.X_train, self.y_train, self.X_valid, self.y_valid, self.X_test, self.y_test=dh.get_data(root)
        # if train == 'train':
        #     #print(self.X_train.shape,self.y_train.shape)
        #     #self.imgs = np.hstack((self.X_train.ravel(32*32*3).tolist(),self.y_train).tolist())
        #     self.imgs = self.X_train
        #     self.labels = self.y_train
        # elif train =='test':
        #     self.imgs = self.X_test
        #     self.labels = self.y_test
        # elif train =='valid':
        #     self.imgs = self.X_valid
        #     self.labels = self.y_valid
